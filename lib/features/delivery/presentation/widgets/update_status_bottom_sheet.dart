...
class UpdateStatusBottomSheet extends StatefulWidget {
  ...
  static Future<DeliveryStatus?> show(BuildContext context) {
    return showModalBottomSheet<DeliveryStatus>(
      context: context,
...
class _UpdateStatusBottomSheetState extends State<UpdateStatusBottomSheet> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          ...DeliveryStatus.values.map((e) => _item(e)),
  ...
  Widget _item(DeliveryStatus status) {
